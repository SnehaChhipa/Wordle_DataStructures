...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    public void setRoot(Position<E> r) {
        //if(this.root != null) // do we thrown an exception;
        this.root = validate(r);
    }
    ...
    public E remove(Position<E> p) throws IllegalArgumentException {
        ...
        if (numChildren(p) == 2) {
            throw new IllegalArgumentException("p has two children. removing not possible");
        }
